...
/**
 * Removing files based on this <a
 * href="http://java.sun.com/developer/technicalArticles/javase/finalization/"
 * >article</a>
 * 
...
final class WeakDataFile extends WeakReference<DataFile> {
	...
	private static final Logger LOGGER = Logger.getLogger(WeakDataFile.class
			.getName());
	...
	static void drainRefQueueBounded() {
		...
		while ((weak != null) && (iterations < MAX_ITERATIONS)) {
			LOGGER.fine("Cleaning file = " + weak.file
					+ " from reference queue.");
			weak.close();
			++iterations;
