...
/**
 * Use {@link RandomAccessFile} for concurrent access of read and write partial
 * part's content.
 * 
...
final class DataFile {
	private final WeakDataFile weak;
	 ...
	 * 
	 * @param data
	 *            that needs to written to a file
	 * @param offset
	 *            start offset in the data
	 * @param length
	 *            no bytes to write
	 * @return file pointer before the write operation(or at which the data is
	 *         written)
	 */
