...
public class RunningJobManagerOld implements RunningJobManager {
	...
	static final Logger myLogger = LoggerFactory
			.getLogger(RunningJobManagerOld.class.getName());
	...
	public RunningJobManagerOld(ServiceInterface si) {
		this.si = si;
