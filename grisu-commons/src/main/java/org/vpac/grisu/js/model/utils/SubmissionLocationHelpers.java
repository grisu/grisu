...
//			return null;
	 ...
	 * 
	 * @param gridResource the GridResource
	 ...
	 * 
	 * @param im a information manager
	 * @param contactString the contact string for this submission location
	 * @param queue the queue name for this submission location
	 * @return the submission location string
	 */
	 ...
	 * 
	 * @param hostname the hostname for this submission location
	 * @param queue the quename for this submission location
	 * @param jobManager the jobmanager for this submission location
	 * @return the submission location string
	 */
