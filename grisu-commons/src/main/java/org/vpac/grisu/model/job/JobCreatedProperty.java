...
public enum JobCreatedProperty {
	...
	/**
	 * The hostname the job is (or is going to be) submitted to (e.g. ng2.vpac.org).
	 */
	...
	/**
	 * The full path of the local workingdirectory on the cluster where the job is (or will be) running.  
	 */
	...
	/**
	 * The current status of the job. Have a look at {@link JobConstants} for values for this key. 
	 */
