...
/**
 * This class contains information from {@link ApplicationInformation} and {@link UserEnvironmentManager} 
...
public interface UserApplicationInformation extends ApplicationInformation {
	 ...
	 */
	public List<GridResource> getBestSubmissionLocations(Map<JobSubmissionProperty, String> additionalJobProperties, String fqan);
