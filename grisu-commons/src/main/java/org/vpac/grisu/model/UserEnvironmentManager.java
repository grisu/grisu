...
public interface UserEnvironmentManager {
	...
	/**
	 * Calculates all mountpoints for the combination of submission location and fqan.
	 * 
	...
	/**
	 * A list of all mountpoints that are connected to the specified submission location.
	 * 
	 * @param submissionLocation the submission location
	...
	/**
	 * Returns a recommended mountpoint for the specified combination of submission location and fqan.
	 * 
	 * @param submissionLocation the submission location
	 * @param fqan the fqan
