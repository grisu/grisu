...
public class ResubmitPolicy {
	 ...
	 * 
	 * Note: along with this you also have to specify one of the RESTART_RESTART_WAITING_JOBS_ON_XXX_LOCATIONS.
	 */
	...
	/**
	 * Queue restart-jobs to locations where jobs have succuessfully run already. Defaults to true.
	 */
	public static final String RESTART_TO_DONE_SUBMISSION_LOCATIONS = "restartToDoneSubLocs";
	/**
	 * Queue restart-jobs to locations where jobs are waiting in the queue and no job run so far. Defaults to false.
	 */
	public static final String RESTART_TO_WAITING_SUBMISSION_LOCATIONS = "restartToWaitingSubLocs";
	/**
	 * Queue restart-jobs to locations where jobs have failed. Defaults to false.
	 */
	public static final String RESTART_TO_FAILED_SUBMISSION_LOCATIONS = "restartToFailedSubLocs";
	/**
	 * Queue restart-jobs to locations where jobs are running at the moment. Defaults to true.
	 */
	public static final String RESTART_TO_RUNNING_SUBMISSION_LOCATIONS = "restartToRunningSubLocs";
	/**
	 * Restart jobs that are currently waiting on a location with currently running jobs. Defaults to false.
	 */
	public static final String RESTART_WAITING_JOBS_ON_RUNNING_LOCATIONS = "restartWaitingJobsOnRunningSubLocs";
	/**
	 * Restart jobs that are currently waiting on a location where jobs already run succesfully. Defaults to false.
	 */
	public static final String RESTART_WAITING_JOBS_ON_DONE_LOCATIONS = "restartWaitingJobsOnDoneSubLocs";
	/**
	 * Restart jobs that are currently waiting on a location with at least one failed job. Defaults to true.
	 */
	public static final String RESTART_WAITING_JOBS_ON_FAILED_LOCATIONS = "restartWaitingJobsOnFailedSubLocs";
	/**
	 * Restart jobs that are currently waiting on a location where no job run so far. Default to true.
	 */
	public static final String RESTART_WAITING_JOBS_ON_WAITING_LOCATIONS = "restartWaitingJobsOnWaitingLocations";
	/**
	 * Convenience option to specify to restart restart-jobs to all available locations, regardless of whether they have finished or failed or waiting jobs. Defaults to false.
	 */
	...
	public DtoProperties toDto() {
		...
		return DtoProperties.createUserProperties(temp);
