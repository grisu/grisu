...
//	public byte[] downloadByteArray(String filename, int offset, int length) throws RemoteFileSystemException, VomsException;
	 ...
	 * @param waitForFileTransferToFinish whether to wait for the file transfer to finish (true) or whether to run the filetransfer in the background
	...
	public String cp(String source, String target, boolean overwrite, boolean waitForFileTransferToFinish) throws RemoteFileSystemException, VomsException;
...
//	public void downloadFolder(String folder) throws RemoteFileSystemException, VomsException;
	 ...
	 * 
	 * Internally, this validates all the jobproperties, tries to auto-fill properties that are not specified (maybe version or submissionlocation). For a list of valid job property keynames have a look here: {@link JobSubmissionProperty}.
