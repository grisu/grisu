...
public class DtoDataLocation {
	...
	/**
	 * A list of (local) relative paths (like "/home/grid-admin") that are
	 * available for the vo that is connected to this datalocation.
	 */
	private List<String> paths;

	/**
	 * The fqan of the VO that is used to create a voms proxy to access this
	 * datalocation.
	 */
	private String fqan;
