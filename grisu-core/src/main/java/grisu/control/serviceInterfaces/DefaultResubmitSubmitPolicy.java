...
public class DefaultResubmitSubmitPolicy implements SubmitPolicy {
	...
	//
	// private final Map<String, String> initProperties = new HashMap<String,
	// String>();
	//
	// private final Map<String, GridResource> cacheGridResourceMap = new
	// HashMap<String, GridResource>();
	//
