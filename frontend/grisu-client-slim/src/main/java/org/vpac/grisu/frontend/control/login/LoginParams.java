...
public class LoginParams {
	 ...
	 * 
	 * @param serviceInterfaceUrl the url of the grisu backend to connect to
	 * @param myProxyUsername your myproxy username
	 * @param myProxyPassphrase your myproxy password
	 */
	...
	/**
	 * This one allows you to specify the myproxy server & port to use. No http proxy is used.
	 * 
	 * @param serviceInterfaceUrl the url of the grisu backend to connect to
	 * @param myProxyUsername your myproxy username
	 * @param myProxyPassphrase your myproxy password
	 * @param myProxyServer the myproxy server to use
	...
	/**
	 * This one allows you to specify the myproxy server & port as well as the http proxy server & port. No http proxy authentication.
	 * 
	 * @param serviceInterfaceUrl the url of the grisu backend to connect to
	 * @param myProxyUsername your myproxy username
	 * @param myProxyPassphrase your myproxy password
	 * @param myProxyServer the myproxy server hostname
	 * @param myProxyPort the myproxy server port
	 * @param httpProxy the http proxy server hostname
	 * @param httpProxyPort the http proxy server port
	 */
	...
	/**
	 * This one allows you to specify everything: myproxy server & port, http proxy server & port & username & password.
	 * 
	 * @param serviceInterfaceUrl the url of the grisu backend to connect to
	 * @param myProxyUsername your myproxy username
	 * @param myProxyPassphrase your myproxy password
	 ...
	 * @param httpProxy the http proxy server hostname
	 * @param httpProxyPort the http proxy server port
	 * @param httpProxyUsername the http proxy server username
	 * @param httpProxyPassphrase the http proxy server password
	 */
	 ...
	 * 
	 * @param serviceInterfaceUrl the serviceInterface url
	 */
	 ...
	 * 
	 * @param myProxyUsername the myproxy username
	 */
	 ...
	 * 
	 * @param myProxyPassphrase the myproxy password
	 */
	 ...
	 * 
	 * @param httpProxy the http proxy server port
	 */
	 ...
	 * 
	 * @param httpProxyUsername the username for the http proxy server
	 */
	...
	/**
	 * Clears the password for the http proxy server in memory. Not the myproxy one, though, since this is still needed after login.
	 */
...
//		}
	 ...
	 * 
	 * @param myProxyPort the myproxy server port to use
	 */
